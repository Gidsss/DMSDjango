...
# Functions to help with building the Markov model
...
# Helper function to convert string to bitstream
...
class Encoder:
    ...
    def step(self):
        ...
        if self.exhausted:
            ...
            if self.logging:
                remaining = f"{self.bitstream[:char_limit]}..." if len(self.bitstream) > char_limit else self.bitstream
